    ...
    <Container maxW={'5xl'} py={30}>
      <SimpleGrid columns={{ base: 1, md: 2 }} spacing={10}>
        <Stack spacing={4}>
          ...
          Біздің компания орман шаруашылығына жаңа технологияларды енгізумен, мемлекеттік орман қорының оффлайн карталарын құрумен айналысады. 
          </Text>
          <h1>Біздің қолдаңбаның беретін мүмкіндіктері </h1>
          <Stack
            spacing={4}
            divider={
